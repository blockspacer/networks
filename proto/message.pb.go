...
type Message struct {
	...
	MessageUid uint64   `protobuf:"varint,1,opt,name=message_uid,json=messageUid,proto3" json:"message_uid,omitempty"`
	From       string   `protobuf:"bytes,2,opt,name=from,proto3" json:"from,omitempty"`
	To         []string `protobuf:"bytes,3,rep,name=to,proto3" json:"to,omitempty"`
	SendTs     uint64   `protobuf:"varint,4,opt,name=send_ts,json=sendTs,proto3" json:"send_ts,omitempty"`
	Message    string   `protobuf:"bytes,5,opt,name=message,proto3" json:"message,omitempty"`
	Reply      []string `protobuf:"bytes,6,rep,name=reply,proto3" json:"reply,omitempty"`
}
...
func (x *Message) GetMessageUid() uint64 {
	if x != nil {
		return x.MessageUid
	}
	return 0
...
func (x *Message) GetSendTs() uint64 {
	if x != nil {
		return x.SendTs
	}
	return 0
...
var file_proto_message_proto_rawDesc = []byte{
	...
	,
